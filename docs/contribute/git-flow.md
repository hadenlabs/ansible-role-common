...
```bash
git remote add upstream  https://github.com/hadenlabs/ansible-role-common.git
```

Now your **upstream** points to **hadenlabs/ansible-role-common**.
...
git fetch upstream # assuming upstream is hadenlabs/ansible-role-common
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/ansible-role-common/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
